...
export default function Home() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      {/* En lugar de escribir 50 líneas de código para el video, solo ponemos esto: */}
      <Hero />

      {/* 3. Servicios */}
      <ServicesSection />

      {/* 4. Staff (Se mantiene igual) */}
      <section id="crew" className="py-24 bg-black px-8 border-t border-white/10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { name: "Marcos", role: "Master Barber", img: "/crew/marcos.jpg" },
              ...
              >
                <div className="aspect-[3/4] bg-neutral-800 relative">
                    {/* Usamos img normal para evitar errores con las fotos de internet */}
                    <img 
                      src={barber.img} 
                      alt={barber.name}
